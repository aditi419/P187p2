...
def startDecryption():
    ...
    btn_open_file = Button(decryption_window, text="Choose File..", font = 'arial 13',bg='blue')
...
def startEncryption():
    ...
    file_name_label = Label(encryption_window, text="File Name: " , font = 'arial 13',bg='lightblue')
    ...
    btn_create = Button(encryption_window, text="Create", font = 'arial 13',command=saveData,bg='lightblue')
...
heading_label = Label(root, text="Encryption & Decryption" , font = 'arial 18 italic',bg='lightblue')
heading_label.place(relx=0.5,rely=0.2, anchor=CENTER)

btn_start_encryption = Button(root, text="Start Encryption" , font = 'arial 13' , command=startEncryption,bg='blue')
btn_start_encryption.place(relx=0.3,rely=0.6, anchor=CENTER)

btn_start_decryption = Button(root, text="Start Decryption" , font = 'arial 13' ,bg='blue' , command=startDecryption)
